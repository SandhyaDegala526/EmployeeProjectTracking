package com.alacriti.projecttracking.constants;

import com.alacriti.projecttracking.model.vo.Error;

public class ErrorConstants {

	public static final Error NO_RECORD_FOUND_WITH_GIVEN_REQUEST_PARAMETERS = new Error(
			"error_req_param", "No record found with given request parameters",
			"");

	public static final Error PROCESS_ERROR = new Error("error_process",
	...
	public static final Error CONFIRM_CHARGE_REQUEST_ERROR = new Error(
			"error_field", "The request contains a field with invalid value.",
			"confirm_charge_request");
	...
	public static final Error EMAIL_ERROR = new Error("error_field",
			"The request contains a field with invalid value.", "email");
	...
	public static final Error ABA_ROUTING_NUMBER_ERROR = new Error(
			"error_field", "The request contains a field with invalid value.",
			"aba_routing_number");

	public static final Error ACCOUNT_ISSUING_INSTITUTION_NAME_ERROR = new Error(
			"error_field", "The request contains a field with invalid value.",
	...
	public static final Error ACCOUNT_HOLDER_NAME_ERROR = new Error(
			"error_field", "The request contains a field with invalid value.",
			"account_holder_name");
	...
	public static final Error VALIDATE_CHARGE_REQUEST_ERROR = new Error(
			"error_field", "The request contains a field with invalid value.",
	...
	public static final Error CHARGE_AMOUNT_CURRENCY_ERROR = new Error(
			"error_field", "The request contains a field with invalid value.",
	...
	public static final Error TOKEN_ERROR = new Error("error_field",
			"The request contains a field with invalid value.", "token_id");
	...
	public static final Error EDIT_PAYMENT_REQUEST_ERROR = new Error(
			"error_field", "The request contains a field with invalid value.",
			"edit_payment_request");

	public static final Error FUNDING_ACCOUNT_ID_ERROR = new Error(
			"error_field", "The request contains a field with invalid value.",
			"funding_account.id");
	public static final Error EDIT_FUNDING_ACCOUNT_REQUEST_ERROR = new Error(
			"error_field", "The request contains a field with invalid value.",
			"edit_funding_account_request");
