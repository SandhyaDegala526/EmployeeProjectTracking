    ...
    this._employeeProjectService.postProjectAllotmentData(this.projectAllotmentForm.value.employeeId,
      ...
      .subscribe(response => {
        console.log(response);
          console.log(this.projectAllotmentForm.value.employeeId);
        console.log('================' + this.projectAllotmentForm.value.projectName);
         console.log( this.projectAllotmentForm.value.employeeStartDate);
        if ( response === true) {
